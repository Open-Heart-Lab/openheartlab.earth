...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b shadow-sm backdrop-blur">
      <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="flex gap-6 text-sm text-gray-700">
          <Link
            href="/#about"
            className={`hover:text-pink-600 ${activeId === 'about' ? 'text-pink-600 font-semibold' : 'text-gray-700'}`}
          >
            About
          </Link>
          <Link
            href="/#offerings"
            className={`hover:text-pink-600 ${activeId === 'offerings' ? 'text-pink-600 font-semibold' : 'text-gray-700'}`}
          >
            Offerings
          </Link>
